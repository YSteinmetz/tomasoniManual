...
\begin{figure}[h]
  \centering
  \includegraphics[width=480px,height=300px]{src/images/01-main/e-Tela-Principal.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=576px,height=360px]{src/images/01-main/e-1.png}
  \caption{ver depois.}
   \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=576px,height=360px]{src/images/01-main/e-2.png}
  \caption{ver depois.}
   \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=576px,height=360px]{src/images/01-main/e-3.png}
  \caption{ver depois.}
   \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=576px,height=360px]{src/images/01-main/e-4.png}
  \caption{ver depois.}
   \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=576px,height=360px]{src/images/01-main/e-5.png}
  \caption{ver depois.}
   \label{}
\end{figure}

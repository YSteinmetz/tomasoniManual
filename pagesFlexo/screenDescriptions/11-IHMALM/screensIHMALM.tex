...
\thispagestyle{fancy}
\vspace*{40 pt}
\subsection{\small{Tela de comandos página 1}}\label{ihmAlimentacaoTelaComandosPagina1}
...
\thispagestyle{fancy}
\vspace*{40 pt}
\subsection{\small{Tela de comandos página 2}}\label{ihmAlimentacaoTelaComandosPagina2}

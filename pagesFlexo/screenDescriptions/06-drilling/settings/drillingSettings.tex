...
\thispagestyle{fancy}
\vspace*{40 pt}
\subsubsection{\small{Ajuste pressão afastada da manta}}\label{telaAjustesPerfuradoraAjustePressaoAfastadaManta}
\vspace*{\fill}
\begin{figure}[h]
  \centering
...
\thispagestyle{fancy}
\vspace*{40 pt}
\subsubsection{\small{Ajuste pressão aproximada da manta}}\label{telaAjustesPerfuradoraAjustePressaoAproximadaManta}
\vspace*{\fill}
\begin{figure}[h]
  \centering

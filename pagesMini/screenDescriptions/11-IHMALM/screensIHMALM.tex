...
\subsection{Tela principal}\label{miniIhmAlimentacaoTelaPrincipal}
...
\thispagestyle{fancy}
\vspace*{40 pt}
\subsection{Tela de comandos página 1}\label{miniIhmAlimentacaoTelaComandosPagina1}
...
\newlist {commandsMiniLineComandsS1}{itemize}{1}
\setlist [commandsMiniLineComandsS1]{label={}, nosep, before=\vspace{10pt}, after=\vspace{10pt}}

 \begin{commandsMiniLineComandsS1}
...
\thispagestyle{fancy}
\vspace*{40 pt}
\subsection{Tela de comandos página 2}\label{miniIhmAlimentacaoTelaComandosPagina2}
...
\newlist {commandsMiniLineComandsS2}{itemize}{1}
\setlist [commandsMiniLineComandsS2]{label={}, nosep, before=\vspace{10pt}, after=\vspace{10pt}}


 \begin{commandsMiniLineComandsS2}
...
\begin{figure}[h]
  \centering
  \includegraphics{src/imagesMiniline/11-IHMALM/e1.png}
\end{figure}
\vspace*{\fill}
...
A diferença é que nesta tela é possível ajustar a espessura da chapa, o esquadrejador frontal e a altura da pilha.
Ao clicar na sigla o nome completo do ajuste é exibido no centro do menu e no caso de movimentos eles se movimentam na direção apresentada no botão clicado,
em velocidade constante até que o botão seja libreado.
...
\begin{figure}[h]
  \centering
  \includegraphics{src/imagesMiniline/11-IHMALM/e2.png}
\end{figure}
\vspace*{\fill}

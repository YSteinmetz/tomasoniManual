...
\setlist[standartsMet]{label="listNR12", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
...
\setlist[machinePartsList]{label="descricaoUnidades", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
...
\setlist[typeOfRisks]{label="listaDeRiscos", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
...
\setlist[generalSafetyRules]{label="recomendacoesDeSeguranca", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
...
\setlist[generalSafetyToStartTheMachine]{label="precaucoesAoLigarAMaquina", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
...
\setlist[generalSafetyToMoveUnities]{label="precaucoesAoDeslocarUnidades", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
\begin{generalSafetyToMoveUnities}
    \item A máquina possui alarme audiovisual para deslocamento das unidades (abertura e fechamento da máquina);
    \item Para habilitar o funcionamento do sistema de deslocamento das unidades é necessário que a máquina esteja
parada;
    \item Deve ser acionado o botão de comando do deslocamento que está situada nas Respectivas Unidades conforme
necessidade;
    \item Verificar entre as unidades se não existem pessoas, peças, etc, em seu interior ou em frente antes de qualquer
deslocamento das unidades;
    \item Nunca faça deslocamentos das unidades manualmente, ou seja, empurrando as unidades. O sistema de
...
\setlist[generalRulesToPlateCleaning]{label="precaucoesAoLimparOsCliches", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
\begin{generalRulesToPlateCleaning}
\item Utilizar os procedimentos de segurança para desabilitar as unidades para ter acesso interno para troca de
clichês nas impressoras e forma na unidade perfuradora;
\item Ao substituir os clichês, formas ou mantas, não apoiar-se nos rolos, preferencialmente deve ser utilizadas as
duas mãos para executar esta tarefa e utilizar os pedais/botões para movimentar os rolos para frente ou para traz
conforme necessidade;
\item Para efetuar limpeza dos clichês, não apoiar-se nos rolos, preferencialmente devem ser utilizadas as duas mãos
...
\setlist[generalRulesForCleaning]{label="precaucoesAoLimparAMaquina", nosep, before=\vspace{10pt}, after=\vspace{10pt}}
\begin{generalRulesForCleaning}
\item  Durante a limpeza e manutenção a máquina normalmente deve ser travada o acionamento por meio da chave
...
\item Se os ajustes elétricos da máquina são usados, deve-se tomar precauções especiais como por exemplo uma
pessoa ficar responsável a supervisionar e impedir a ação de outra pessoa a uma operação perigosa;
\item Após o término da limpeza ou manutenção as tampas, proteções e carenagens devem ser colocadas em seus
lugares;
\item A manutenção regular da máquina deve incluir verificações dos dispositivos de segurança, sensores de
segurança e chaves de emergência;
\item Modificações que irão influenciar no funcionamento dos sistemas de segurança nunca devem ser feitas. As
